      ...
      <AnimatePresence>
        {!isFullScreenPlayerOpen && (
          <motion.div 
            ...
            className="fixed bottom-16 sm:bottom-4 left-3 right-3 sm:left-6 sm:right-6 max-w-5xl mx-auto z-40 pointer-events-auto"
          >
            <div className="flex items-center justify-between gap-3 px-3 sm:px-4 py-2 sm:py-2.5 rounded-2xl bg-neutral-950/95 text-white border border-neutral-800 shadow-2xl backdrop-blur-xl hover:border-neutral-700 transition-all">
              ...
              <div className="flex items-center gap-2.5 sm:gap-3 min-w-0 flex-1 sm:flex-initial">
                <motion.button
                  ...
                  className="relative w-11 h-11 sm:w-12 sm:h-12 rounded-xl overflow-hidden bg-neutral-900 shrink-0 border border-neutral-800 group focus:outline-none focus:ring-2 focus:ring-amber-500 shadow-md cursor-pointer"
              ...
              <div className="flex items-center gap-1.5 sm:gap-3">
                ...
                <motion.button
                  ...
                  className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-amber-500 text-neutral-950 flex items-center justify-center shadow-lg transition-all font-bold cursor-pointer"
              ...
              <div className="flex items-center gap-1 sm:gap-1.5">
                ...
                <motion.button
                  ...
                  className="p-2 rounded-xl text-neutral-300 hover:text-amber-400 hover:bg-white/10 transition-colors cursor-pointer flex items-center gap-1"
                ...
                <motion.button
                  ...
                  className="p-2 rounded-xl text-neutral-300 hover:text-red-400 hover:bg-white/10 transition-colors cursor-pointer flex items-center gap-1"
                ...
                <motion.button
                  ...
                  className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl bg-white/10 hover:bg-white/20 text-white text-xs font-semibold transition-all shadow-sm cursor-pointer"
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.9 }}
                  onClick={() => hapticLight()}
                  className="p-2 rounded-xl text-red-500 hover:text-red-400 hover:bg-red-500/10 transition-colors cursor-pointer"
