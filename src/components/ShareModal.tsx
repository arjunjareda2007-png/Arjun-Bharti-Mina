...
export const ShareModal: React.FC = () => {
  ...
  // Ultra-robust clipboard copy with textarea fallback for all browser contexts
  ...
  const handleCopyLink = async () => {
    ...
    if (ok) {
      ...
      showToast('Please copy link manually from input box', 'info');
    }
  };

  const handleCopyFormattedCard = async () => {
  ...
  const handleNativeDeviceShare = async () => {
    ...
    if (shared) {
      showToast('Shared via device sheet!', 'success');
      closeShare();
    } else {
      handleCopyLink();
    }
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-neutral-100 dark:border-neutral-800 bg-neutral-50/80 dark:bg-neutral-950/80">
          ...
          <button 
            onClick={closeShare} 
            className="p-1.5 rounded-full text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-200 hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors button-press"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="p-6 space-y-5 max-h-[80vh] overflow-y-auto">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2 bg-neutral-100 dark:bg-neutral-800/80 p-2 rounded-2xl border border-neutral-200 dark:border-neutral-700/80">
              <input 
                type="text" 
                readOnly 
                value={targetUrl}
                className="flex-1 bg-transparent text-xs text-neutral-700 dark:text-neutral-300 focus:outline-none truncate font-mono px-2"
              />
              <button
                onClick={handleCopyLink}
                className="px-3.5 py-1.5 rounded-xl bg-amber-500 hover:bg-amber-400 text-neutral-950 text-xs font-bold flex items-center gap-1.5 transition-colors shrink-0 shadow-sm button-press cursor-pointer"
              >
            ...
            <div className="p-4 rounded-2xl bg-amber-500/5 border border-amber-500/20 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                <button
                  ...
                  className="px-3 py-2.5 rounded-xl bg-neutral-900 text-white dark:bg-white dark:text-neutral-950 text-xs font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition-opacity shadow-sm button-press"
                >
                ...
                <button
                  ...
                  className="px-3 py-2.5 rounded-xl bg-blue-600 text-white text-xs font-semibold flex items-center justify-center gap-2 hover:bg-blue-700 transition-colors shadow-sm button-press"
                >
                ...
                <button
                  ...
                  className="px-3 py-2.5 rounded-xl bg-neutral-200 dark:bg-neutral-800 text-neutral-800 dark:text-neutral-200 text-xs font-semibold flex items-center justify-center gap-2 hover:bg-neutral-300 dark:hover:bg-neutral-700 transition-colors button-press"
                >
            ...
            <div className="p-4 rounded-2xl bg-neutral-50 dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button
                  ...
                  className="px-3 py-2 rounded-xl bg-neutral-900 text-white dark:bg-white dark:text-neutral-950 text-xs font-semibold flex items-center justify-center gap-2 hover:opacity-90 transition-opacity shadow-sm disabled:opacity-50 button-press"
                >
                ...
                <button
                  ...
                  className="px-3 py-2 rounded-xl bg-neutral-200 dark:bg-neutral-800 text-neutral-800 dark:text-neutral-200 text-xs font-semibold flex items-center justify-center gap-2 hover:bg-neutral-300 dark:hover:bg-neutral-700 transition-colors button-press"
                >
              ...
              <div className="flex flex-wrap gap-2">
                {shareData.streamingLinks.spotify && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="px-2.5 py-1.5 rounded-xl bg-[#1DB954]/10 text-[#1DB954] text-[11px] font-semibold flex items-center gap-1.5 hover:bg-[#1DB954]/20 transition-colors button-press"
                  >
                ...
                {shareData.streamingLinks.youtube && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="px-2.5 py-1.5 rounded-xl bg-red-600/10 text-red-500 text-[11px] font-semibold flex items-center gap-1.5 hover:bg-red-600/20 transition-colors button-press"
                  >
                ...
                {shareData.streamingLinks.jiosaavn && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="px-2.5 py-1.5 rounded-xl bg-emerald-600/10 text-emerald-500 text-[11px] font-semibold flex items-center gap-1.5 hover:bg-emerald-600/20 transition-colors button-press"
                  >
                    <span>JioSaavn</span>
                  </a>
                )}
                {shareData.streamingLinks.gaana && (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="px-2.5 py-1.5 rounded-xl bg-rose-600/10 text-rose-500 text-[11px] font-semibold flex items-center gap-1.5 hover:bg-rose-600/20 transition-colors button-press"
                  >
                    <span>Gaana</span>
                  </a>
                )}
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex flex-col items-center justify-center p-3 rounded-2xl bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 transition-all text-center text-xs font-semibold border border-emerald-500/20 button-press hover-lift"
              >
                <span>WhatsApp</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex flex-col items-center justify-center p-3 rounded-2xl bg-sky-500/10 hover:bg-sky-500/20 text-sky-600 dark:text-sky-400 transition-all text-center text-xs font-semibold border border-sky-500/20 button-press hover-lift"
              >
                <span>X (Twitter)</span>
              </a>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex flex-col items-center justify-center p-3 rounded-2xl bg-blue-500/10 hover:bg-blue-500/20 text-blue-600 dark:text-blue-400 transition-all text-center text-xs font-semibold border border-blue-500/20 button-press hover-lift"
              >
                <span>Telegram</span>
              </a>
              ...
              <button
                ...
                className="flex flex-col items-center justify-center p-3 rounded-2xl bg-amber-500/10 hover:bg-amber-500/20 text-amber-600 dark:text-amber-400 transition-all text-center text-xs font-semibold border border-amber-500/20 button-press hover-lift cursor-pointer"
              >
